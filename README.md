...
| **ClimateChat**       | ClimateChat                         | [HuggingFace](https://huggingface.co/itpossible/ClimateChat)<br>[Wisemodel](https://wisemodel.cn/models/itpossible/ClimateChat) | Instruction model <br> Fine-tuned on JiuZhou-base for instruction following |
